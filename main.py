...
parser.add_argument('--train_dataset', default='animal_faces8')
parser.add_argument('--test_dataset', default='animal_faces9')
parser.add_argument('--content_path', default='heiti-02')
parser.add_argument('--target_path', default='songti-04')
